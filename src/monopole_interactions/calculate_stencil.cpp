...
namespace fmm {
    namespace monopole_interactions {
        ...
        std::pair<oct::vector<multiindex<>>, oct::vector<oct::array<real, 4>>> calculate_stencil() {
            oct::array<oct::vector<multiindex<>>, 8> stencils;
            ...
            oct::vector<multiindex<>> superimposed_stencil;
            ...
            oct::vector<oct::array<real, 4>> four_constants;
            ...
            return std::pair<oct::vector<multiindex<>>, oct::vector<oct::array<real, 4>>>(
        ...
        calculate_stencil_masks(oct::vector<multiindex<>> superimposed_stencil) {
            ...
            oct::array<real, 4> four_constants_defaults = {0, 0, 0, 0};
            oct::vector<bool> stencil_masks(FULL_STENCIL_SIZE, false);
            oct::vector<oct::array<real, 4>> four_constants_stencil(FULL_STENCIL_SIZE, four_constants_defaults);
            for (auto stencil_element : superimposed_stencil) {
            ...
            return std::pair<oct::vector<bool>, oct::vector<oct::array<real, 4>>>(stencil_masks, four_constants_stencil);
