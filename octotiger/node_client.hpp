...
public:
	...
	void send_hydro_children( oct::vector<real>&&, const geo::octant& ci, std::size_t cycle) const;
	void send_hydro_flux_correct( oct::vector<real>&&, const geo::face& face, const geo::octant& ci) const;
	void send_read_flux_correct( oct::vector<real>&&, const geo::face& face, const geo::octant& ci) const;
	void send_rad_flux_correct( oct::vector<real>&&, const geo::face& face, const geo::octant& ci) const;
...
//	hpx::future<void> set_parent(hpx::id_type);
	...
	future<void> form_tree(hpx::id_type&&, hpx::id_type&&, oct::vector<hpx::id_type>&& );
	...
	void send_flux_check(oct::vector<real>&&, const geo::direction& dir, std::size_t cycle) const;
	void send_hydro_boundary(oct::vector<real>&&, const geo::direction& dir, std::size_t cycle) const;
    ...
    future<void> send_rad_children( oct::vector<real>&&, const geo::octant& ci, std::size_t cycle) const;
	future<void> send_rad_boundary(oct::vector<real>&&, const geo::direction&, std::size_t cycle) const;
